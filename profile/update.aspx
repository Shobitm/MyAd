                    ...
                    <div id="main-contact-form" class="contact-form">
                       ...
                       <asp:RequiredFieldValidator ValidationGroup="val1" ID="RequiredFieldValidator1" runat="server" ControlToValidate="title" ErrorMessage="Title is Required" CssClass="text-danger"></asp:RequiredFieldValidator>
                        ...
                        <div class="form-group">
                         ...
                         <asp:RequiredFieldValidator ValidationGroup="val1" ID="RequiredFieldValidator2" runat="server" ControlToValidate="urls" ErrorMessage="URL is Required" CssClass="text-danger"></asp:RequiredFieldValidator>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                               ...
                               <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" >
                                ...
                                <asp:Button ValidationGroup="val1" ID="Button1" runat="server" Text="update details" class="btn btn-success" Height="50px" Width="205px" OnClick="Button1_Click" />       
